...
There was a strong linear relationship between F~[c,t]~ and harvested whole tree carbon (Figure `r fluxmassfig`). Both F~[c,t]~ and whole tree carbon were reduced under elevated CO~2~ (30.5 and 31.8%, respectively) while no effects of the drought treatment were detected (Table 1). Overall, F~[c,t]~ was correlated with total leaf area at the final harvest (P < 0.001, R2 = 0.59).    
