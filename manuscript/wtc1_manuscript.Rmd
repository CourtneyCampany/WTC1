...
\
During each survey period, M~br~ was estimated by solving the above equation with $\text{L}_{br}$ and $\text{A}_{br}$ for individual branches with $\phi_{br}$$\rho_{br}$ specific to each WTC. We assumed that $phi_{br}\rho_{br}$ did not change through time. Total dry branch mass at each survey point was the total mass of all individual branches.
