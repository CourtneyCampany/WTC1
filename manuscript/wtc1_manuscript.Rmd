...
## Branch carbon mass
Measured dry mass, length and basal area of harvested branches was used to determine the branch wood density ($\rho_{br}$) as well as a geometric shape factor [$\phi$, see @makela1997carbon] for each WTC by rearranging the equation:
