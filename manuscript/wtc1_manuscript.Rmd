...
## C flow within the WTC

```{r concept, echo=FALSE, error=TRUE,fig.width=8, fig.height=6,dev="png", dpi=400, dev.args=list(type="cairo")}
library(png)
...
# List of Figures
**Figure 1**. Conceptual diagram depicting the major components of C flow among plant components including; uptake via *A~n~*, allocation to component tissues, tissue respiration and root exudation. Net aboveground C uptake ($\text{F}_{c,T}$), shown in the shaded box, represents the flux of C measured within each WTC. With the WTC experimental design, total belowground C allocation (TBCA) is measured as the residual between $\text{F}_{c,T}$ and total aboveground C mass. 
