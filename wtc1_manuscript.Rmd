...
Floors installed above the soil surface permitted the chambers to functions as cuvettes and allowed for whole tree fluxes of CO^2^ and water to be monitored once trees were ca. 3.5 m in height.  High resolution CO^2^ flux data (ca. 14 min intervals) were available for the final year of the experiment. For expression of chamber CO^2^ fluxes on a canopy basis, through time, leaf area was estimated leaf counting in April 2008 and from the final harvest in March 2009. Canopy leaf area was interpolated through time height growth and litter fall rates, assuming that total cumulative leaf area followed and allometric relationship with tree height [@barton2010whole].
