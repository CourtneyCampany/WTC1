...
finalC <- subset(treeC, Date=="2009-03-16")
  ...
  finalC <- merge(finalC, roots)
  finalC$treeC <- finalC$aboveC + finalC$root_mass
...
points(treeC ~ Date , data = finalC[finalC$chamber == "ch01",], pch = 21, bg = "grey", cex=2)
...
points(treeC ~ Date , data = finalC[finalC$chamber == "ch02",], pch = 21, bg = "grey", cex=2)
...
points(treeC ~ Date , data = finalC[finalC$chamber == "ch03",], pch = 21, bg = "grey", cex=2)
...
points(treeC ~ Date , data = finalC[finalC$chamber == "ch04",], pch = 21, bg = "grey", cex=2)
...
points(treeC ~ Date , data = finalC[finalC$chamber == "ch05",], pch = 21, bg = "grey", cex=2)
...
points(treeC ~ Date , data = finalC[finalC$chamber == "ch06",], pch = 21, bg = "grey", cex=2)
...
points(treeC ~ Date , data = finalC[finalC$chamber == "ch07",], pch = 21, bg = "grey", cex=2)
axis(2, labels=TRUE, outer=FALSE)
...
points(treeC ~ Date , data = finalC[finalC$chamber == "ch08",], pch = 21, bg = "grey", cex=2)
...
points(treeC ~ Date , data = finalC[finalC$chamber == "ch09",], pch = 21, bg = "grey", cex=2)
...
points(treeC ~ Date , data = finalC[finalC$chamber == "ch10",], pch = 21, bg = "grey", cex=2)
...
points(treeC ~ Date , data = finalC[finalC$chamber == "ch11",], pch = 21, bg = "grey", cex=2)
axis.Date(1, at = xAT, labels = TRUE, outer=FALSE)
...
points(treeC ~ Date , data = finalC[finalC$chamber == "ch12",], pch = 21, bg = "grey", cex=2)
axis.Date(1, at = xAT, labels = TRUE, outer=FALSE)
