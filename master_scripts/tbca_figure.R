...
below_dat <- rbind(below_means$CO2cum.mean,below_means$TBCA.mean, below_means$Fs_resid.mean)

se_dat <- c(below_means$CO2cum.se,below_means$TBCA.se, below_means$Fs_resid.se)
means_dat <-  c(below_means$CO2cum.mean,below_means$TBCA.mean, below_means$Fs_resid.mean)
##reorder
