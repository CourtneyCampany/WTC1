...
#lmf
par(mar=c(0,7,0,2))
with(tree_C, plot(lmf~treeC, ylab="", xaxt='n', xlab="", xlim=c(5000,25000), ylim=c(.15,.375), type='n'))
...
text(x=25000, y=0.365,labels="(a)", cex=1.5)

#smf
par(mar=c(0,7,0,2))
with(tree_C, plot(smf~treeC,  ylab="", xaxt='n', yaxt='n', xlab="",ylim=c(.35,.75), xlim=c(5000,25000),type='n'))
...
text(x=25000, y=0.73,labels="(b)", cex=1.5)

#rmf
par(mar=c(0,7,0,2))
with(tree_C, plot(rmf~treeC,  ylab="", xaxt='n',yaxt='n',xlab= "",ylim=c(.15, .3), xlim=c(5000,25000),type='n'))
...
text(x=25000, y=0.29,labels="(c)", cex=1.5)
