...
leaf_mod3 <- lm(leafcarbon ~ CO2_treatment, data=tree_C)
(mean(tree_C[tree_C$CO2_treatment=="ambient", "leafcarbon"]) - mean(tree_C[tree_C$CO2_treatment=="elevated", "leafcarbon"]))/mean(tree_C[tree_C$CO2_treatment=="ambient", "leafcarbon"])
